<!-- ========== CONNECT BDD ========== -->
	<?php
		...
		echo('<span id="participants_5">Il y a </span><u><b><span style="color:red">'.$final[0].'</span></b></u><span id="participants_6"> participants.</span><br>');
